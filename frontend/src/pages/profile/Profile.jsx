...
function Profile() {
    ...
    if (validateProfile()) {
      try {
        ...
        if (response.status === 200 && response.data) {
          console.log("Profile updated, navigating to chat...");
  ...
  return (
    <div className="bg-[#1b1c24] h-[100vh] px-4 md:px-10 flex items-center justify-center flex-col gap-10">
      <div className="flex flex-col gap-10 w-full md:w-[80vw] lg:w-max">
        ...
        <div className="flex flex-wrap  gap-3.5 md:gap-5">
          ...
          >
            <Avatar className="h-32 w-32 md:w-48 md:h-48 rounded-full overflow-hidden">
              {image ? (
                ...
                <div
                  className={`uppercase h-32 w-32 md:w-48 md:h-48 text-3xl md:text-5xl border-[1px] flex items-center justify-center rounded-full ${getColor(
                    selectedColor
                  )}`}
                >
                  {firstName
          ...
          <div className="flex flex-1 flex-col gap-5 text-white items-center md:items-start">
            ...
            <div className="w-full flex gap-2 md:gap-5 flex-wrap">
